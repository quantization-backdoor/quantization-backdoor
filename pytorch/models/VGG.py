...
class VGG(nn.Module):
    def __init__(self, vgg_name='VGG16'):
        ...
        self.classifier = Linear(in_features=512, out_features=10, bias=False)
    ...
    def _make_layers(self, cfg):
        ...
        for x in cfg:
            if x == 'M':
                ...
                layers += [Conv2d(in_channels=in_channels, out_channels=x, kernel_size=3, padding=1, bias=False),
                           nn.BatchNorm2d(x),
